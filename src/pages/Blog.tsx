...
const Blog = () => {
  ...
  const categories = ["ALL", "LAMBORGHINI", "FERRARI", "PORSCHE", "MCLAREN"];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                Exploring the world of exceptional sports and luxury cars
                through curated selections, detailed insights, and a passion for
              ...
              {categories.map((category) => {
                const flagGradient =
                  category === "FERRARI" || category === "LAMBORGHINI"
                    ? "linear-gradient(to right, #009246, #ffffff, #ce2b37)" // Italy
                    : category === "MCLAREN"
                      ? "linear-gradient(to right, #cf142b, #ffffff, #00247d)" // UK
                      : category === "PORSCHE"
                        ? "linear-gradient(to right, #000000, #dd0000, #ffce00)" // Germany
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12">
              Subscribe to our newsletter for the latest auctions on sport and
              luxury cars
            </p>
